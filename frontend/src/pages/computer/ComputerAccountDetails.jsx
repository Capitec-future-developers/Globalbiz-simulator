...
// This page mirrors Computer/"Account details.html", which is a static
// drill-down for the business's Transactional Account (the desktop
// equivalent of the mobile AccountDetails.jsx screen for accId=
// 'transactional'). Balances/transactions come from the same shared
// useAccountStore the mobile App and ComputerHome read, so a payment made
// on either platform is reflected here too.
const ACCOUNT_ID = 'transactional';
...
export default function ComputerAccountDetails() {
    ...
    // Reconstruct a running "Balance" column the same way the source
    // table shows one: transactions are stored newest-first, so the
    // current balance applies to the most recent row and we walk
    // backwards from there for older rows.
            ...
            <div className="account-box">
                <div className="account-info-row">
                    <div className="info-item">
                        <span className="info-label"><img src="/images/transact-white.svg" alt="" /></span>
                        <span className="info-value" style={{ position: 'relative', left: 50, top: -25, fontWeight: 'bold', fontSize: 20 }}>Zenzi</span>
                    </div>
                    <div className="yohyoh">
                        ...
                        <div className="info-item"><span className="info-label">Current balance:</span> <span className={'info-value' + (bal.balance < 0 ? ' negative' : '')}>{formatCurrency(bal.balance)}</span></div>
                ...
                <div className="manage-btn-container" style={{ backgroundColor: '#0078d7', position: 'absolute', border: '1px solid #ffffff', right: 50 }}>
                    <button className="manage-btn" type="button">Manage Account</button>
