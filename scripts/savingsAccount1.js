    ...
    const tabContentData = {
        transactions: [
            ...
            <tr>
                <td>8 July 2025</td>
                <td>Credit</td>
                <td>Sanity from 1553248753</td>
                <td class="positive">R5 000.00</td>
                <td>R0.00</td>
                <td class="positive">R5 000.00</td>
            </tr>
            <tr>
                <td>10 July 2025</td>
                <td>Credit</td>
                <td>Retail Cr Rainy days</td>
                <td class="positive">R5 800.00</td>
                <td>R0.00</td>
                <td class="positive">R10 800.00</td>
            </tr>
            </tbody>
        </table>`
        ],
        ...
        stampedStatements: [
            "Statement for June 2025",
            "Statement for May 2025",
            "Statement for April 2025"
        ],
        accountInformation: [
            "Account opened: 28 july 2024",
            "Account status: Active",
            "Overdraft limit: R0.00",
            "Linked accounts: Savings (1052 2626 43)"
        ]
    };
